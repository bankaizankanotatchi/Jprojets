...
class CreateProjetScreen extends StatefulWidget {
  ...
  const CreateProjetScreen({
    Key? key,
    required this.databaseService,
  }) : super(key: key);
  
  @override
  _CreateProjetScreenState createState() => _CreateProjetScreenState();
}
...
class _CreateProjetScreenState extends State<CreateProjetScreen> {
  ...
  Future<void> _createProjet() async {
    if (_formKey.currentState!.validate()) {
      setState(() => _isLoading = true);
      
      try {
        await widget.databaseService.creerProjet(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: _isLoading ? null : _createProjet,
                              tooltip: 'Enregistrer',
                            ),
                          ],
                        ),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GradientButton(
                      onPressed: _isLoading ? null : _createProjet,
                      text: _isLoading ? 'Création...' : 'Créer le projet',
                      gradient: LinearGradient(
                        begin: Alignment.topLeft,
                        end: Alignment.bottomRight,
                        colors: [
