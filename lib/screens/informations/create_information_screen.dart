...
class CreateInformationScreen extends StatefulWidget {
  ...
  @override
  _CreateInformationScreenState createState() => _CreateInformationScreenState();
}
...
class _CreateInformationScreenState extends State<CreateInformationScreen> {
  ...
  Future<void> _createInformation() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        await widget.databaseService.creerInformation(
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Information enregistrée avec succès'),
